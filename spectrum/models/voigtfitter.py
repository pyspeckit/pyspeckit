...
class voigt_fitter(object):
    ...
    def moments(self, Xax, data, vheight=True, estimator=median, negamp=None,
        ...
        """Returns (height, amplitude, x, Gwidth_x, Lwidth_x)
        the gaussian parameters of a 1D distribution by calculating its
        moments.  Depending on the input parameters, will only output a subset
        of the above.  Unfortunately, I don't know how to estimate a Lorentzian
        width...
        ...
        # assume Gaussian and Lorentzian widths are identical
        mylist = [amplitude,xcen,width_x,width_x]
