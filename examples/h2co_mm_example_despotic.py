...
# models.formaldehyde_mmm.build_despotic_grids(gridfile='ph2cogrid.fits')
...
sp = psk.readers.read_class.class_to_spectra('example_h2co_mm_spectrum.apex', apex=True)
...
sp.specfit(fittype='formaldehyde_mm_despotic',
           guesses=[95, 14.5, 4, 75, 4.0],
           limits=[(50,300), (11,15), (2,7), (-20,150), (0.35,10)],
           limited=[(True, True)]*5,
