        ...
        for filename in filelist:
            ...
            if options.interactive:
                ...
                if options.hcop:
                    ...
                    print >>fout_hcop,"".join(["%20s" % s for s in ("Source_Name","scannum","amplitude","center","width","amp_err","cen_err","wid_err","RMS")])
                    hcop = print_timing(class_to_obsblocks)(filename,telescope=['SMT-F1M-HL','SMT-F1M-VL'],line=['HCOP(3-2)','HCO+(3-2)','HCOP','HCO+'])
                    for sp in hcop:
                ...
                if options.n2hp:
                    ...
                    print >>fout_n2hp,"".join(["%20s" % s for s in ("Source_Name","scannum","amplitude","center","width","amp_err","cen_err","wid_err","RMS")])
                    n2hp = print_timing(class_to_obsblocks)(filename,telescope=['SMT-F1M-HU','SMT-F1M-VU'],line=['N2HP(3-2)','N2H+(3-2)','N2HP','N2HO','N2DP','N2HO(3-2)','N2DP(3-2)'])
