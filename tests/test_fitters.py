...
lmfit_times = timeit.Timer('test_fitters.test_fittypes(True,"leastsq")',setup='import test_fitters').repeat(3,30)
mpfit_times = timeit.Timer('test_fitters.test_fittypes(False,"leastsq")',setup='import test_fitters').repeat(3,30)

lmfit_nosetup_times = timeit.Timer('test_fitters.test_fitspeed(True,"leastsq")',setup='import test_fitters').repeat(3,30)
mpfit_nosetup_times = timeit.Timer('test_fitters.test_fitspeed(False,"leastsq")',setup='import test_fitters').repeat(3,30)

print "lmfit: ",lmfit_times,lmfit_nosetup_times
print "mpfit: ",mpfit_times,mpfit_nosetup_times
