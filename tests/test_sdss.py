...
spec.specfit(guesses = [30, 6800, 60, 5, 6863, 3, 5, 6883, 3], annotate = False, interactive = False,)
raw_input("Wait here a moment")
spec.specfit(guesses = [30, 6800, 60, 5, 6863, 3, 5, 6883, 3, 5, 7010, 3, 5, 7040, 3], annotate = False, interactive = False,)
raw_input("Wait here a moment")
