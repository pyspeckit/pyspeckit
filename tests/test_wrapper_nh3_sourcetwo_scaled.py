...
if True:
    ...
    figure(5)
    savefig("example_G032.020_multi-temperature_three-line_fit_etambscaled.png")
    figure(7)
    savefig("example_G032.020_multi-temperature_three-line_fit_etambscaled_components.png")
    figure(8)
    savefig("example_G032.020_multi-temperature_three-line_fit_etambscaled_residuals.png")

    figure(9,figsize=[16,12])
    pyspeckit.wrappers.fitnh3.plot_nh3(spdict1,spectra1,fignum=9,errstyle='fill')
    savefig("example_G032.020_multi-temperature_three-line_fit_etambscaled_errbars.png")
