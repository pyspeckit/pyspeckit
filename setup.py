...
if os.path.exists(".hg"):
    ...
    try:
        currentversion = subprocess.Popen("git rev-list HEAD --count".split(),stdout=subprocess.PIPE).communicate()[0].strip()
        version = version_base+"git"+currentversion
        download_url = "https://github.com/pyspeckit/pyspeckit/archive/master.zip"
    except:
        version = version_base
        download_url = "https://github.com/pyspeckit/pyspeckit/archive/master.zip"
else:
